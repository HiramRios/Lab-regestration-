...
<head>
    ...
    <title>CS4342 Add Project Participant</title>
...
<body>
    <div style="margin-top: 20px" class="container">
        ...
        <form action="create_Participant.php" method="post">
            ...
            <div class="form-group">
                <label for="Project_id">Project ID (Note: There must be an PID already created & no dublicates)</label>
