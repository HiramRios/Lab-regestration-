...
<head>
    ...
    <title>CS4342 Project Managers</title>
...
<body style="background-color:#003366;">
    <div style="margin-top: 20px" class="container">
        ...
        body{color: orange;}
        </style>Projects and their Managers</h1><br>
    ...
    $sql = "SELECT PName, FFullName FROM PROJECT P, MANAGES M, FACULTY F WHERE P.PID = M.PID AND M.FEmail = F.FEmail    ;";
