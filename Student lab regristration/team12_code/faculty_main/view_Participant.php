...
<body>
    <?php $sql = "SELECT * FROM PARTICIPATES";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="update_Participant_interface.php?PK=<?php echo $row[0] ?>,<?php echo $row[1] ?>">Update</a></td>
                        <td><a href="delete_Participant.php?PK=<?php echo $row[0] ?>,<?php echo $row[1] ?>">Delete</a></td>
                    </tr>
                <?php
                }
                ?>
