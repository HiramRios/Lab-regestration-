...
if (isset($_POST['FEmail'])){
  ...
  //echo $PID;
  $query = "DELETE from MANAGES where FEmail = '".$FEmail."' AND PID = $OPID ";
  mysqli_query($conn, $query);

  $query_project  = "INSERT INTO MANAGES (FEmail,PID) VALUES ('".$FEmail."', $PID);";
  //$query = "UPDATE MANAGES SET PID = $PID WHERE FEmail = '".$FEmail."'";
  //echo $query;
  //echo "\n";
  ...
  if (mysqli_query($conn, $query_project)) {
    ...
    //recovery
    $query_project  = "INSERT INTO MANAGES (FEmail,PID) VALUES ('".$FEmail."', $OPID);";
