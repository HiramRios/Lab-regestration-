            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="update_A_SID_interface.php?PK=<?php echo $row[0] ?>,<?php echo $row[1] ?>">Update</a></td>
                        <td><a href="delete_A_SID.php?PK=<?php echo $row[0] ?>,<?php echo $row[1] ?>">Delete</a></td>
                    </tr>
                <?php
                }
                ?>
