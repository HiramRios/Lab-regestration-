...
<head>
    ...
    <title>CS4342 Assign Faculty to Report</title>
...
<body>
    <div style="margin-top: 20px" class="container">
        <h1>Assign Faculty to Report:</h1>
        <!-- styling of the form for bootstrap https://getbootstrap.com/docs/4.5/components/forms/ -->
        <form action="create_F_to_RID.php" method="post">
            <div class="form-group">
                <label for="FEmail">Email (Note: There must be an FEmail already created)</label>
                <input class="form-control" type="text" id="email" name="email">
            </div>
            <div class="form-group">
                <label for="report_id">Report ID (Note: There must be an RID already created & no Duplicates allowed)</label>
    ...
    <?php
        ...
        if (isset($_POST['Submit'])){
            ...
            $query_faculty  = "INSERT INTO Faculty_Reports (FEmail,RID) VALUES ('".$FEmail."', $RID);";
