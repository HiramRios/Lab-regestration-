...
<body>
    <?php $sql = "SELECT * FROM Faculty_Reports";
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td><a href="update_F_to_RID_interface.php?PK=<?php echo $row[0] ?>,<?php echo $row[1] ?>">Update</a></td>
                        <td><a href="delete_F_to_RID.php?PK=<?php echo $row[0] ?>,<?php echo $row[1] ?>">Delete</a></td>
                    </tr>
                <?php
                }
                ?>
