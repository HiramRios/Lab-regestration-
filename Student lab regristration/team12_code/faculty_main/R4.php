...
<head>
    ...
    <title>CS4342 Faculty & Students</title>
...
<body style="background-color:#003366;">
    <div style="margin-top: 20px" class="container">
        ...
        body{color: orange;}
        </style>Faculty and their Students</h1><br>
    ...
    $sql = "SELECT FFullName, Sname FROM FACULTY F, ADDS A, STUDENT S WHERE  F.FEmail = A.FEmail AND A.SID = S.SID  ;";
