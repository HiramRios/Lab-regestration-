...
<head>
    ...
    <title>CS4342 Faculty Update</title>
    ...
    <div style="margin-top: 20px" class="container">
        ...
        <form action="update_faculty.php" method="post">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="first_name" name="first_name" value="<?php echo $row['FFirstName'] ?>">
            </div>
            <div class="form-group">
                <label for="middle_name">Middle Name</label>
                <input class="form-control" type="text" id="middle_name" name="middle_name" value="<?php echo $row['FMiddleName'] ?>">
            </div>
            <div class="form-group">
                <label for="last_name">Last Name</label>
                <input class="form-control" type="text" id="last_name" name="last_name" value="<?php echo $row['FLastName'] ?>">
            </div>
            <div class="form-group">
        ...
        <div>
            <br>
            <a href="view_faculty.php">Back to View Faculty</a></br>
        </div>
