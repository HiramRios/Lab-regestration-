...
if (isset($_GET['PK'])){
    ...
    $sql = "SELECT * FROM MANAGES where FEmail = '".$email."' AND PID = $PID;";
    //echo $sql;
...
<head>
    ...
    <title>CS4342 Project Managers Update</title>
...
<body>
    <div style="margin-top: 20px" class="container">
        ...
        <form action="update_Manage.php" method="post"><!--CHANGE THIS-->
        ...
        <div>
            <br>
            <a href="view_Manage.php">Back to View Managers</a></br>
        </div>
