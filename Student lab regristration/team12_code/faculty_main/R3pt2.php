...
<head>
    ...
    <title>CS4342 Project Participants</title>
...
<body style="background-color:#003366;">
    <div style="margin-top: 20px" class="container">
        ...
        body{color: orange;}
        </style>Projects and their Participants</h1><br>
    ...
    $sql = "SELECT PName, FFullName FROM PROJECT P, PARTICIPATES Pa, FACULTY F WHERE P.PID = Pa.PID AND Pa.FEmail = F.FEmail    ;";
