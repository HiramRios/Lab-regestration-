...
<body>
    <?php $sql = "SELECT * FROM REPORT"; //UPDATE THIS
            ...
            <tbody>
                ...
                ?>
                    ...
                    <td><?php printf("%s", $row[0]); ?></td>
                        ...
                        <td><a href="update_report_interface.php?RID=<?php echo $row[0] ?>">Update</a></td>
                        <td><a href="delete_report.php?RID=<?php echo $row[0] ?>&PID=<?php echo $row[1] ?>&DDeviceID=<?php echo $row[2]?>">Delete</a></td>
                    </tr>
                <?php
                }
                ?>
